---
title: "The Importance of Reproducible Burgers"
...
school_data <- readxl::read_excel("~/Google Drive/ALL THE THINGS/PhD/code/R/burgr-reproducible-talk/data/burgr_data_example.xlsx", 
                          skip = 1)
...
school_data_clean %>%
    add_predictions(preds = lm_fit_school) %>%
    ggplot(data = .,
           aes(x = `Grade 5`,
               y = preds)) + 
    geom_point()
